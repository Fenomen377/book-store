...
class BookSerializerTestCase(TestCase):
    def test_ok(self):
        ...
        user2 = User.objects.create(username='user2', first_name='Alexey', last_name='Pestrov')
        ...
        UserBookRelation.objects.create(user=user2, book=book_1, like=True,
                                        rate=5)
        user_book3 = UserBookRelation.objects.create(user=user3, book=book_1, like=True)
        user_book3.rate = 4
        user_book3.save()
